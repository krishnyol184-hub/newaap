    ...
    <div className="glass p-4" data-testid="document-uploader">
      {!compact && (
        <div className="flex items-center gap-2 mb-3">
          <FaCloudUploadAlt className="text-teal-400 text-xl" />
          ...
          {files.map((f, i) => (
            <div key={i} className="flex items-center justify-between p-2 rounded-lg bg-white/[0.03] border border-white/5">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <span className="text-xs text-teal-400 uppercase tracking-widest font-semibold shrink-0">{kindLabel(f.kind)}</span>
                ...
                <FaCheckCircle className="text-teal-400 text-xs shrink-0" />
              </div>
