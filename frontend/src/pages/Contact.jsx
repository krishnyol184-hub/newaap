      ...
      <div className="grid md:grid-cols-3 gap-6 mt-8">
        <div className="md:col-span-1 space-y-3">
          {[
            ...
            const Icon = c.icon;
            const content = (
              <div className="glass p-4 flex items-start gap-3 hover:border-teal-500/40 transition" data-testid={`contact-info-${i}`}>
                <div className="w-10 h-10 rounded-xl bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center shrink-0"><Icon /></div>
                <div>
                  <div className="text-xs font-semibold text-teal-400 uppercase tracking-widest">{c.title}</div>
