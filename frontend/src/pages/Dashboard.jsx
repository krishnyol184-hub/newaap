...
const Dashboard = () => {
  ...
  const stats = [
    { icon: FaSolarPanel, label: lang === "hi" ? "सोलर आवेदन" : "Solar Applications", val: solar.length, color: "from-teal-500 to-teal-700" },
    ...
    <div className="max-w-7xl mx-auto px-4 py-10" data-testid="dashboard-page">
      ...
      <div className="glass p-4">
        <div className="flex gap-2 border-b border-white/5 mb-4 pb-1">
          <button className={`px-4 py-2 font-semibold text-sm rounded-lg transition ${tab === "solar" ? "bg-teal-500/10 text-teal-400 border border-teal-500/30" : "text-slate-400 hover:text-white"}`} onClick={() => setTab("solar")} data-testid="tab-solar">
