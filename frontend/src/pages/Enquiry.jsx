        ...
        <aside className="space-y-4">
          ...
          <div className="glass p-5" data-testid="enquiry-side-hours">
            ...
            <div className="flex items-center gap-3 text-sm text-slate-300">
              <span className="w-9 h-9 rounded-lg bg-blue-500/10 border border-blue-500/30 text-blue-400 flex items-center justify-center"><FaClock /></span>
          ...
          <div className="glass p-5" data-testid="enquiry-side-address">
            ...
            <div className="flex items-start gap-3 text-sm text-slate-300">
              <span className="w-9 h-9 rounded-lg bg-blue-500/10 border border-blue-500/30 text-blue-400 flex items-center justify-center shrink-0"><FaMapMarkerAlt /></span>
