    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-16" data-testid="enquiry-success-page">
        <div className="glass-strong p-8 md:p-10 text-center">
          <div className="w-16 h-16 mx-auto rounded-full bg-teal-500/15 border border-teal-500/40 text-teal-400 flex items-center justify-center text-3xl mb-4">
            <FaCheckCircle />
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-teal-300 font-mono" data-testid="enquiry-ref-no">
    ...
    <div className="max-w-6xl mx-auto px-4 py-10" data-testid="enquiry-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <form onSubmit={submit} className="glass p-6 md:p-8 space-y-5 lg:col-span-2" data-testid="enquiry-form">
          ...
          <div className="p-3 rounded-lg bg-teal-500/[0.06] border border-teal-500/20 text-[11px] text-teal-200/90 flex items-start gap-2" data-testid="enquiry-privacy-note">
            <FaShieldAlt className="text-teal-400 mt-0.5 shrink-0" />
            <div>
              {hi
        ...
        <aside className="space-y-4">
          <div className="glass p-5" data-testid="enquiry-side-contact">
            <div className="text-xs uppercase text-teal-400 font-semibold tracking-widest mb-3">
              {hi ? "सीधा संपर्क" : "Direct Contact"}
            </div>
            <div className="space-y-3 text-sm">
              <a href="tel:8168762016" className="flex items-center gap-3 text-slate-300 hover:text-teal-400">
                <span className="w-9 h-9 rounded-lg bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center"><FaPhone /></span>
                <div>
              ...
              <a href="https://wa.me/918168762016" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-slate-300 hover:text-teal-400">
                <span className="w-9 h-9 rounded-lg bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center"><FaWhatsapp /></span>
                <div>
                  <div className="text-[10px] text-slate-500 uppercase tracking-widest">WhatsApp</div>
                  <div className="font-semibold">8168762016</div>
                </div>
              </a>
              <a href="mailto:haryanaenterpriseskagdana@gmail.com" className="flex items-center gap-3 text-slate-300 hover:text-teal-400">
                <span className="w-9 h-9 rounded-lg bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center"><FaEnvelope /></span>
                <div>
          ...
          <div className="glass p-5" data-testid="enquiry-side-hours">
            ...
            <div className="flex items-center gap-3 text-sm text-slate-300">
              <span className="w-9 h-9 rounded-lg bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center"><FaClock /></span>
          ...
          <div className="glass p-5" data-testid="enquiry-side-address">
            ...
            <div className="flex items-start gap-3 text-sm text-slate-300">
              <span className="w-9 h-9 rounded-lg bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center shrink-0"><FaMapMarkerAlt /></span>
