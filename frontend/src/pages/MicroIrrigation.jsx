  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10" data-testid="irrigation-page">
      ...
      <div className="glass-strong relative overflow-hidden mb-8 p-6 md:p-10" data-testid="irrigation-hero">
        <div className="absolute -right-24 -top-24 w-96 h-96 rounded-full bg-teal-500/10 blur-3xl pointer-events-none"></div>
            ...
            <div key={s.id} className="glass overflow-hidden group relative" data-testid={`irrigation-card-${s.id}`}>
              ...
              <div className="p-5">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 rounded-xl bg-teal-500/10 border border-teal-500/30 text-teal-400 flex items-center justify-center"><Icon /></div>
                  <div>
