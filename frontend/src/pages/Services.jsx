  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12" data-testid="services-page">
        ...
        {cards.map((c, i) => {
          ...
          return (
            <Link key={i} to={c.to} className="svc-card" data-testid={`service-card-${i}`}>
              ...
              <div className="text-teal-400 text-xs font-semibold inline-flex items-center gap-1">
      ...
      <div className="mt-10 glass p-5 flex items-start gap-3 text-sm text-slate-300 leading-relaxed" data-testid="services-compliance-note">
        <FaShieldAlt className="text-teal-400 mt-1 shrink-0" />
        <div>
          ...
          <ul className="space-y-1.5">
            {[
              ...
              <li key={i} className="flex items-start gap-2 text-slate-400 text-xs"><FaCheckCircle className="text-teal-400 mt-0.5 shrink-0" /> <span>{hi ? n.hi : n.en}</span></li>
            ))}
          </ul>
        </div>
      </div>
