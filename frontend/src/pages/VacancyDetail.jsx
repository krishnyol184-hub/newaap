...
const KIND_META = {
  ...
  notification: { hi: "अधिसूचना PDF",    en: "Notification PDF",   icon: FaFilePdf,         cls: "bg-blue-500/10 border-blue-500/30 hover:bg-blue-500/15",     iconCls: "text-blue-400" },
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10" data-testid="vacancy-detail-page">
      ...
      {expired ? (
        ...
        <div className="mb-5 rounded-xl border-2 border-red-500/60 bg-gradient-to-r from-red-500/15 via-blue-500/15 to-red-500/15 p-4 flex items-center gap-3 shadow-lg shadow-red-500/20 animate-pulse-slow" data-testid="vacancy-urgent-banner">
          <div className="w-11 h-11 rounded-full bg-gradient-to-br from-red-500 to-blue-500 text-white flex items-center justify-center text-xl shrink-0 shadow-lg shadow-red-500/40">
            <FaClock />
          </div>
          <div className="flex-1">
            <div className="text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-blue-300 font-extrabold text-lg tracking-wide uppercase">
              {days === 0
            ...
            <div className="text-blue-200/90 text-xs mt-0.5">
              {lang === "hi"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6" data-testid="vacancy-stats">
        ...
        <div className={`stat-card ${urgent ? "stat-red-glow" : "stat-amber"}`}>
          ...
          {days !== null && days >= 0 && !expired && (
            <div className={`stat-sub ${urgent ? "text-red-200" : "text-blue-200"}`}>
      ...
      {(v.structured?.salary || v.structured?.age_limit || v.qualification || v.structured?.selection || v.structured?.job_location) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6" data-testid="vacancy-secondary">
          ...
          {v.structured?.age_limit && (
            <div className="detail-row">
              <div className="detail-icon bg-blue-500/10 text-blue-400"><FaUserCheck /></div>
              <div className="flex-1 min-w-0">
