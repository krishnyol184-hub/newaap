    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-slate-50" data-testid="admin-login-page">
      <div className="w-full max-w-md rounded-2xl shadow-2xl bg-white border border-slate-200 p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-11 h-11 rounded-xl bg-teal-600 text-white grid place-items-center">
            <FaCog />
          </div>
          <div>
        ...
        <form onSubmit={submit} className="space-y-4">
          <label className="block">
            ...
            <div className="mt-1 flex items-center gap-2 border border-slate-300 rounded-lg px-3 focus-within:border-teal-500">
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full py-3 rounded-lg bg-teal-600 hover:bg-teal-700 disabled:opacity-60 text-white font-semibold inline-flex items-center justify-center gap-2 transition-colors"
