      ...
      <form onSubmit={upload} className="bg-white rounded-2xl border border-slate-200 p-5 mb-6 flex flex-col md:flex-row md:items-end gap-3">
        <label className="flex-1">
          ...
          <input
            ...
            className="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 focus:border-teal-500 outline-none text-sm bg-white"
        ...
        <label className="flex-1">
          ...
          <input
            ...
            className="mt-1 w-full text-sm text-slate-500 file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:font-bold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100"
        ...
        <button
          type="submit"
          disabled={uploading}
          className="px-5 py-2.5 rounded-lg bg-teal-600 hover:bg-teal-700 disabled:opacity-60 text-white text-sm font-semibold inline-flex items-center justify-center gap-2 shrink-0"
        ...
        {loading ? (
          ...
          items.map((t) => (
            <div key={t.id} className="flex items-center gap-4 px-5 py-4 hover:bg-slate-50/60" data-testid={`admin-resume-row-${t.id}`}>
              <span className="w-10 h-10 rounded-lg bg-teal-100 text-teal-700 grid place-items-center shrink-0"><FaFileAlt /></span>
