      ...
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <button
            onClick={save}
            disabled={busy || !dirty}
            className="px-4 py-1.5 rounded-lg bg-teal-600 disabled:bg-slate-300 hover:bg-teal-700 text-white text-xs font-semibold inline-flex items-center gap-1.5"
          ...
          <label key={f} className="block">
            ...
            {isLongField(f) ? (
              <textarea
                ...
                rows={3}
                className="mt-1 w-full px-3 py-2 rounded-lg border border-slate-300 focus:border-teal-500 outline-none text-sm text-slate-900 bg-white"
